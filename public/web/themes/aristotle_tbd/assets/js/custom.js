...
var backButton = document.getElementById("edit-back");
if (backButton) {
  backButton.removeAttribute("disabled");
  backButton.classList.remove("is-disabled");
  backButton.value = "Back to front page";
  }
});

window.onload = function () {
  if (window.location.href.includes("/answer/")) {
    var nextButton = document.getElementById("edit-submit");
    var containerElement = document.querySelector('.page-main .container');
    var headerElement = document.querySelector('.opigno-header-wrapper');
    var footerElement = document.getElementById('footer-area');

    if (containerElement) {
      containerElement.style.transition = 'max-width 0.3s ease-in-out';
      containerElement.style.maxWidth = '1600px';
    }

    if (headerElement && footerElement) {
      headerElement.style.transition = 'opacity 0.3s ease-in-out';
      footerElement.style.transition = 'opacity 0.3s ease-in-out';
    ...
    if (nextButton) {
      nextButton.addEventListener("click", function (event) {
        if (typeof API_1484_11 !== "undefined") {
          var completionStatus = API_1484_11.GetValue("cmi.completion_status");
          ...
          if (completionStatus !== "completed") {
            ...
            Swal.fire({
              ...
              text: 'You must complete the course before proceeding.',
              confirmButtonText: 'OK',
              confirmButtonColor: '#FF3A21',
            });
          }
        }
      });
