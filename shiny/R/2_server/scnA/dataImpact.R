...
# impact data ####
impact_data <- eventReactive(input$run, {
  data <- svydata()
  
  data$adj_welfare <- data$adj_welfare*econ()$cpi22/econ()$cpi_sy
  ...
  data$pov <- ((data$adj_welfare) < econ()$natpline * econ()$cpi22/econ()$cpi_sy) * 100
  data$gap <- ((econ()$natpline * econ()$cpi22/econ()$cpi_sy - data$adj_welfare) * (data$pov == 100) / (econ()$natpline * econ()$cpi22/econ()$cpi_sy)) * 100
  data$povI1 <- ((data$adj_welfare) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline1) * 100
  data$povI2 <- ((data$adj_welfare) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline2) * 100
  data$povI3 <- ((data$adj_welfare) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline3) * 100
  data$gapI1 <- ((econ()$intpline1 - data$adj_welfare / (econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data$povI1 == 100) / econ()$intpline1) * 100
  data$gapI2 <- ((econ()$intpline2 - data$adj_welfare / (econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data$povI2 == 100) / econ()$intpline2) * 100
  data$gapI3 <- ((econ()$intpline3 - data$adj_welfare / (econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data$povI3 == 100) / econ()$intpline3) * 100
  ...
  for (i in c("A", "matA", "childA", "disabA", "oldA", "B")) {
    ...
    if (check1 > 0) {
      #Baseline 
      data[[paste0("pre_pov_", i)]] <- ((data$adj_welfare - data[[paste0("value_", i)]]) < econ()$natpline * econ()$cpi22/econ()$cpi_sy) * 100
      data[[paste0("pre_gap_", i)]] <- ((econ()$natpline * econ()$cpi22/econ()$cpi_sy - (data$adj_welfare - data[[paste0("value_", i)]])) * (data[[paste0("pre_pov_", i)]] == 100) / (econ()$natpline * econ()$cpi22/econ()$cpi_sy)) * 100
      data[[paste0("pre_povI1_", i)]] <- ((data$adj_welfare - data[[paste0("value_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline1) * 100
      data[[paste0("pre_povI2_", i)]] <- ((data$adj_welfare - data[[paste0("value_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline2) * 100
      data[[paste0("pre_povI3_", i)]] <- ((data$adj_welfare - data[[paste0("value_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline3) * 100
      data[[paste0("pre_gapI1_", i)]] <- ((econ()$intpline1 - (data$adj_welfare - data[[paste0("value_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data[[paste0("pre_povI1_", i)]] == 100) / econ()$intpline1) * 100
      data[[paste0("pre_gapI2_", i)]] <- ((econ()$intpline2 - (data$adj_welfare - data[[paste0("value_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data[[paste0("pre_povI2_", i)]] == 100) / econ()$intpline2) * 100
      data[[paste0("pre_gapI3_", i)]] <- ((econ()$intpline3 - (data$adj_welfare - data[[paste0("value_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data[[paste0("pre_povI3_", i)]] == 100) / econ()$intpline3) * 100
      #Post reforms national poverty outcomes
      if (check2 > 0) {
      data[[paste0("post_pov_", i)]] <- ((data$adj_welfare - data[[paste0("value_", i)]] + data[[paste0("transfer_", i)]]) < econ()$natpline * econ()$cpi22/econ()$cpi_sy) * 100
      data[[paste0("post_gap_", i)]] <- ((econ()$natpline * econ()$cpi22/econ()$cpi_sy  - (data$adj_welfare - data[[paste0("value_", i)]] + data[[paste0("transfer_", i)]])) * (data[[paste0("post_pov_", i)]] == 100) / (econ()$natpline * econ()$cpi22/econ()$cpi_sy)) * 100
      data[[paste0("post_povI1_", i)]] <- ((data$adj_welfare - data[[paste0("value_", i)]] + data[[paste0("transfer_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline1) * 100
      data[[paste0("post_povI2_", i)]] <- ((data$adj_welfare - data[[paste0("value_", i)]] + data[[paste0("transfer_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline2) * 100
      data[[paste0("post_povI3_", i)]] <- ((data$adj_welfare - data[[paste0("value_", i)]] + data[[paste0("transfer_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline3) * 100
      data[[paste0("post_gapI1_", i)]] <- ((econ()$intpline1 - (data$adj_welfare - data[[paste0("value_", i)]] + data[[paste0("transfer_", i)]]) /(econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data[[paste0("post_povI1_", i)]] == 100) / econ()$intpline1) * 100
      data[[paste0("post_gapI2_", i)]] <- ((econ()$intpline2 - (data$adj_welfare - data[[paste0("value_", i)]] + data[[paste0("transfer_", i)]]) /(econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data[[paste0("post_povI2_", i)]] == 100) / econ()$intpline2) * 100
      data[[paste0("post_gapI3_", i)]] <- ((econ()$intpline3 - (data$adj_welfare - data[[paste0("value_", i)]] + data[[paste0("transfer_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data[[paste0("post_povI3_", i)]] == 100) / econ()$intpline3) * 100
      } else {
      ...
      #Post reforms national poverty outcomes
      if (check2 > 0) {
        data[[paste0("post_pov_", i)]] <-  ((data$adj_welfare + data[[paste0("transfer_", i)]]) < econ()$natpline * econ()$cpi22/econ()$cpi_sy) * 100
        data[[paste0("post_gap_", i)]] <- ((econ()$natpline * econ()$cpi22/econ()$cpi_sy - (data$adj_welfare + data[[paste0("transfer_", i)]])) * (data[[paste0("post_pov_", i)]] == 100) / (econ()$natpline * econ()$cpi22/econ()$cpi_sy)) * 100
        data[[paste0("post_povI1_", i)]] <- ((data$adj_welfare + data[[paste0("transfer_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline1) * 100
        data[[paste0("post_povI2_", i)]] <- ((data$adj_welfare + data[[paste0("transfer_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline2) * 100
        data[[paste0("post_povI3_", i)]] <- ((data$adj_welfare + data[[paste0("transfer_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11) < econ()$intpline3) * 100
        data[[paste0("post_gapI1_", i)]] <- ((econ()$intpline1 - (data$adj_welfare + data[[paste0("transfer_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data[[paste0("post_povI1_", i)]] == 100) / econ()$intpline1) * 100
        data[[paste0("post_gapI2_", i)]] <- ((econ()$intpline2 - (data$adj_welfare + data[[paste0("transfer_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data[[paste0("post_povI2_", i)]] == 100) / econ()$intpline2) * 100
        data[[paste0("post_gapI3_", i)]] <- ((econ()$intpline3 - (data$adj_welfare + data[[paste0("transfer_", i)]]) / (econ()$ppp * econ()$cpi22/econ()$cpi11)) * (data[[paste0("post_povI3_", i)]] == 100) / econ()$intpline3) * 100
      } else {
        data[[paste0("post_pov_", i)]] <- data$pov
        data[[paste0("post_gap_", i)]] <- data$gap
        data[[paste0("post_povI1_", i)]] <- data$povI1
...
# summary data
deciledata <- eventReactive(input$run, {
  total <- impact_data() %>% group_by(decile) %>% summarise(meancov_A = weighted.mean(cov_A, weight), 
  ...
  total$female_head <- 2
  total$rural <- 2
  female_head <- impact_data() %>% group_by(decile, female_head) %>% summarise(meancov_A = weighted.mean(cov_A, weight), 
                                                                               meanexp_A = weighted.mean(increase_A,weight),
                                                                               meanbenexp_A = weighted.mean(increase_A,wta_A),
  ...
  rural <- impact_data() %>% group_by(decile, rural) %>% summarise(meancov_A = weighted.mean(cov_A, weight), 
                                                                   meanexp_A = weighted.mean(increase_A,weight),
                                                                   meanbenexp_A = weighted.mean(increase_A,wta_A),
...
age5yrsdata <- eventReactive(input$run, {
  total <- impact_data() %>% group_by(age5yrs) %>% summarise(meanpov = weighted.mean(pov,weight),
  ...
  total$female_head <- 2
  total$rural <- 2
  female_head <- impact_data() %>% group_by(age5yrs, female_head) %>% summarise(meanpov = weighted.mean(pov,weight),
                                                                                meangap = weighted.mean(gap,weight),
                                                                                meancov_A = weighted.mean(cov_A, weight), 
                                                                                meanpov_A = weighted.mean(post_pov_A,weight),
                                                                                meangap_A = weighted.mean(post_gap_A,weight),
  ...
  rural <- impact_data() %>% group_by(age5yrs, rural) %>% summarise(meanpov = weighted.mean(pov,weight),
                                                                    meangap = weighted.mean(gap,weight),
                                                                    meancov_A = weighted.mean(cov_A, weight), 
                                                                    meanpov_A = weighted.mean(post_pov_A,weight),
                                                                    meangap_A = weighted.mean(post_gap_A,weight),
...
hhtypedata <- eventReactive(input$run, {
    total <- impact_data() %>% group_by(hhtype3) %>% summarise(meancov_A = weighted.mean(cov_A, weight,na.rm = TRUE), 
    ...
    total$female_head <- 2
    total$rural <- 2
    female_head <- impact_data() %>% group_by(hhtype3, female_head) %>% summarise(meancov_A = weighted.mean(cov_A, weight,na.rm = TRUE), 
                                                                                  meanexp_A = weighted.mean(increase_A,weight,na.rm = TRUE),
                                                                                  meanbenexp_A = weighted.mean(increase_A,wta_A,na.rm = TRUE),
    ...
    rural <- impact_data() %>% group_by(hhtype3, rural) %>% summarise(meancov_A = weighted.mean(cov_A, weight,na.rm = TRUE), 
                                                                      meanexp_A = weighted.mean(increase_A,weight,na.rm = TRUE),
                                                                      meanbenexp_A = weighted.mean(increase_A,wta_A,na.rm = TRUE),
...
totaldata <- eventReactive(input$run, {
  data <- impact_data()
  ...
  total$rural <- 2
  rural <- impact_data() %>% group_by(rural) %>% summarise(meancov_A = weighted.mean(cov_A, weight), 
                                                             meanexp_A = weighted.mean(increase_A,weight),
                                                             meanbenexp_A = weighted.mean(increase_A,wta_A),
